"""
This scripts makes figure S7i in the paper.
"""

"""
This script produces figure S7H (the right part) of the paper.
This is the mean value of the auditory kernel as a function of ML and AP position
"""
...
def main():
    ...
    fig_name = 'fig-s7g.pdf'

    process_params = dict(
        plot_kernel_weights_and_depth_in_probe=dict(
            plot_active_dataset=False,
    ...
    if param_dict['plot_active_dataset']:
        ...
        weight_and_pos_df_list = [
            all_models_df, all_models_df, all_models_df, all_models_df
        ]
        ...
        metrics_to_plot = ['absVisKernelMean']
