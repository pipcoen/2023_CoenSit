"""
This scripts generates figure 3e : Visual stimulus decoding
...
def main():
    ...
    # TOP PANEL : DECODING SCATTER
    all_classification_results_df = pd.read_pickle(
        '/Volumes/Partition 1/data/interim/active-decode-stim/vis_lr_subset_30_neurons_no_balancing_0_to_300ms_5_subsamples_min_25_labels.pkl')

    fig_name = '4_decode_vis_LR_subset_30_neuron_no_balancing_0_to_300ms_custom_ylim_w_pval'
    fig_ext = '.pdf'

    custom_subset_brain_regions = ['MOs', 'ACA', 'PL', 'OLF', 'ORB', 'ILA']
    # subset brian regions we want
    ...
    lower_limit = -1  # originally -0.3
    custom_ylim = [-1, 1]  # oriignally [-0,3, 1]

    acc_metric = 'accuracyRelBaseline'

    print('Max value: %.3f' % np.max(all_classification_results_df[acc_metric]))
    print('Min value: %.3f' % np.min(all_classification_results_df[acc_metric]))
    ...
    with plt.style.context(splstyle.get_style('nature-reviews')):
        ...
        fig, ax = vizmodel.plot_brain_region_decoding_acc_comparison(all_classification_results_df,
                                                                     exp_var_name='exp',
                                                                     acc_metric=acc_metric, jitter_level=0.05,
        ...
        ax.set_title('Decoding visual left/right', size=12)
    ...
    # BOTTOM PANEL: STATS / DISC PLOT
    # Load decoding results
    # decoding_result_path = '/home/timothysit/Documents/msi-key-data/active-decode-stim/vis_lr_subset_30_neurons_no_balancing_0_to_300ms_5_subsamples_min_25_labels.pkl'
    decoding_result_path = files_folder_path = '/media/timsit/Partition 1/data/interim/active-decode-stim/vis_lr_subset_30_neurons_no_balancing_0_to_300ms_5_subsamples_min_25_labels.pkl'
    ...
    # 2021-11-29 New order to compare
    # brain_region_order = ['MOs', 'PL', 'ORB', 'ACA', 'ILA', 'OLF']
    ...
    with plt.style.context(splstyle.get_style('nature-reviews')):
        ...
        fig_name = 'active_visLeftRight_decoding_all_brain_region_stats_new_order.pdf'
