"""
This script generates figure S6d from the paper :
This is the decoding accuracy after movement onset
...
def main():
    files_folder_path = '/Volumes/Partition 1/data/interim/active-m2-choice-init-decoding/decodeChoiceThreshDir/window30'
