"""
This scripts generates figure 4c of the paper
This is the full model error (AV + interaction term) + movement vs. additive model error + movenet, during active conditions
"""
...
def main():
    ...
    df = pd.read_csv('/Volumes/Partition 1/data/interim/temp/active_model_ridge_10/active_3_plus_2_versus_4_plus_2_mse_error.csv')
